...
function educationalVisualPromptLines(subject){
  ...
  const arith='EDU_ARITH: pro kompaktní mřížku písemných početních příkladů použij {"operation":"subtract|add|multiply|divide","columns":4,"items":[[38,19],[61,25],[145,77]]}. Každá dvojice je jeden příklad a v žákovské verzi se vykreslí svisle pod sebe s čárou a prázdným místem pro výsledek. Příklad NEOPAKUJ ještě horizontálně jako „38 − 19 =“. Při zachování struktury drž počet položek a počet sloupců originálu.';

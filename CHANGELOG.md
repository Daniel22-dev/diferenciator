...
## 1.3.8 — P2: sjednocení platformy GHRAB (2026-08-04)
...
- jednotný název PWA cache `ghrab-differentiator-v1.3.8` a řízená aktualizace;
...
- Etapa P0: bezpečný best-effort start reportéru, konfigurovatelný přístup k AI Studiu, server-ready deployment profil a regresní ochrana proti výpadku diagnostické vrstvy.
## 1.3.5 — 2026-08-03

- reportér sjednocen se společným základem AI Studio GHRAB;
- centrální instance je vypnuta a lokální adaptér respektuje `body.dark`;
- aktualizovány manifest, service worker, regresní testy a odkaz na centrální návod.

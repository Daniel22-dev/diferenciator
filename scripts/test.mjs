...
const REPO="diferenciator",APP_ID="differentiator",FIELD_ID="baseText",SUITE="TestSystem.runAll()",ITEM="#testResults .test-item",FAIL="#testResults .test-item.fail",CACHE_PREFIX="diferenciator-";

...
const report={schema:'ghrab-suite-session-qa-v1',appId:'differentiator',appVersion:'1.3.42',platformVersion:'1.1.2',syntheticOnly:true,mode:'deterministic-multi-context-simulation',cases:[]};

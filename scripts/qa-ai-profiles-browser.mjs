...
try{
  ...
  await client.eval(`window.__qaSample={worksheet_title:'QA worksheet',student_instructions:'Work carefully.',tasks:'1. QA task',answer_key:'1. QA answer',teacher_note:'QA note'};`);
